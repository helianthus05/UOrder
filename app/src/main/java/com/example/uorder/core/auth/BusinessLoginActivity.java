...
public class BusinessLoginActivity extends AppCompatActivity {
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, task -> {
                        if (task.isSuccessful()) {
                            checkBusinessRoleAndRedirect(mAuth.getCurrentUser().getUid(), email);
                        } else {
                            Toast.makeText(BusinessLoginActivity.this, "Authentication failed: " + task.getException().getMessage(),
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        btnGoogle.setText(R.string.google_sign_in);
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        checkBusinessRoleAndRedirect(userId, email);
                    } else {
    ...
    private void checkBusinessRoleAndRedirect(String userId, String email) {
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (document != null && document.exists()) {
                            ...
                            Intent intent = new Intent(this, BusinessRegisterActivity.class);
